...
<h1 id="summary-report-vies">Summary Report (VIES)</h1>

<blockquote>
<p>Update 31.05.2024</p>
</blockquote>
<p>Standard functionality is used to create the Summary Report.</p>
<p>The difference compared to the standard functionality is in the structure of the XML file generated for the purposes of Slovak reporting.</p>
...
<div class="TIP">
<h5>Tip</h5>
<p>You can find the complete XML schema settings in the Configuration Package, which you can obtain by running the Assisted Setup <em>Set Up SK Localization</em> (either import the latest version using the <em>AssistEdit</em> button in the existing company or perform a complete import of the sample parameterization in an empty company using the <em>Apply package</em> action).</p>
</div>
...
<li>In the <strong>XML port ID</strong> field, select the value for the relevant year of validity - see the table below.</li>
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/ARICOMA-D365BC/AC-IB-dynamics365smb-docs/blob/master/business-central/Solutions/sk-vies.md/#L1" class="contribution-link">Improve this document</a>
                  </li>
                </ul>
              </div>
