...
<h5>Note</h5>
<p sourcefile="Solutions/gptom-integration-setup.md" sourcestartlinenumber="24">The GP Tom application also allows the registration of cash or cryptocurrency payments, These options are supported, however no other settings are described in Business Central where the registration of such operations would make sense.</p>
</div>
...
<li sourcefile="Solutions/gptom-integration-setup.md" sourcestartlinenumber="31">In the <em sourcefile="Solutions/gptom-integration-setup.md" sourcestartlinenumber="31">GP tom Transaction Timeout (s)</em> field, leave the default value unless you have a specific request to reduce or extend the time that Business Central does not finish waiting for a response from the terminal.</li>
