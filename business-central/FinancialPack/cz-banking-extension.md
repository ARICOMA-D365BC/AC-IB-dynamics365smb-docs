...
For a description of the import automation settings, see [Automatic downloading of statements to the central stack](cz-banking-extension-setup\#automatic-downloading-of-statements-to-the-central-stack)
> [!TIP]
